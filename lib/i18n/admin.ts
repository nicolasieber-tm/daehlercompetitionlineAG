...
export const admin = {
  ...
  translations: {
    title: "Übersetzungen",
    subtitle:
      "Englische Fassung der Produkttexte aus der Excel-Preisliste. Wird nach jedem Import automatisch ergänzt, hier prüfen und korrigieren. Fehlt eine Übersetzung, zeigt das Tool den deutschen Text.",
    stats: {
      total: "{count} Texte im Katalog",
      translated: "{count} übersetzt",
      auto: "{count} automatisch",
      manual: "{count} geprüft",
      missing: "{count} fehlend",
    },
    run: {
      button: "Fehlende übersetzen",
      buttonCount: "Fehlende übersetzen ({count})",
      running: "Übersetzt …",
      nothing: "Alle Texte sind übersetzt.",
      noKey: "Kein ANTHROPIC_API_KEY gesetzt, automatische Übersetzung nicht verfügbar.",
      joined: "Ein Übersetzungslauf war bereits aktiv, Ergebnis übernommen.",
      done: "{translated} von {missing} Texten übersetzt.",
      doneWithProblems: "{translated} von {missing} Texten übersetzt, {rejected} verworfen, {failed} Batch(es) fehlgeschlagen.",
      failed: "Übersetzen fehlgeschlagen: {error}",
    },
    filter: {
      label: "Filter",
      all: "Alle",
      ...
      missing: "Fehlend",
      search: "Suche",
      searchPlaceholder: "Deutsch oder Englisch …",
      apply: "Anwenden",
      reset: "Zurücksetzen",
    },
    table: {
      columns: {
        source: "Deutsch (Excel)",
        target: "Englisch",
        origin: "Herkunft",
      },
      kind: {
        ...
        detail: "Stufen-Detail",
        group: "Gruppentitel",
        category: "Kategorie",
        note: "Hinweis",
      },
      usage: "{count}× im Katalog",
      originAuto: "automatisch",
      originManual: "geprüft",
      originMissing: "fehlt",
      missingHint: "Noch keine Übersetzung, der Flow zeigt den deutschen Text.",
      save: "Speichern",
      saving: "Speichert …",
      saved: "Gespeichert.",
      clearHint: "Leer speichern entfernt die Übersetzung, der nächste Lauf übersetzt den Text neu.",
      empty: "Keine Texte für diesen Filter.",
    },
    pagination: {
      total: "{count} Texte",
      prev: "Zurück",
